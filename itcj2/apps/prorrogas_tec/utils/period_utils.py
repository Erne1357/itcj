"""
Utilidades de períodos académicos para Prorrogas.
Fuente: itcj/apps/prorrogas_tec/utils/period_utils.py
"""
...
def is_student_window_open() -> bool:
    ...
    db = SessionLocal()
    try:
        return prorrogas_period_service.is_student_window_open(db)
    finally:
        db.close()
