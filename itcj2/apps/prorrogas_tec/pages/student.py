...
Rutas:
  GET /prorrogas/student/home     → Home del estudiante
...
logger = logging.getLogger("itcj2.apps.prorrogas_tec.pages.student")

router = APIRouter(prefix="/student", tags=["prorrogas_tec-pages-student"])

_require_student = require_page_roles("prorrogas_tec", ["student"])
...
@router.get("/home", name="prorrogas_tec.pages.student.home")
async def student_home(
    ...
    return render_prorrogas_tec(request, "prorrogas_tec/student/home.html", {
        "title": "Alumno - Inicio",
        # "has_appointment": has_appt,
    })


@router.get("/requests", name="prorrogas_tec.pages.student.requests")
async def student_requests(
    request: Request,
    user: dict = Depends(_require_student),
):
    """Lista de solicitudes del estudiante (accesible con ventana abierta o cerrada)."""
    return render_prorrogas_tec(request, "prorrogas_tec/student/requests.html", {
        "title": "Alumno - Mis solicitudes",
    })


@router.get("/request", name="prorrogas_tec.pages.student.new_request")
async def student_new_request(
    ...
    return render_prorrogas_tec(request, "prorrogas_tec/student/new_request.html", {
        "title": "Alumno - Nueva solicitud",
    })


@router.get("/close", name="prorrogas_tec.pages.student.close")
async def student_close(
    ...
    if _is_window_open():
        return RedirectResponse("/prorrogas/student/home", status_code=302)
    ...
    return render_prorrogas_tec(request, "prorrogas_tec/student/close.html", {
