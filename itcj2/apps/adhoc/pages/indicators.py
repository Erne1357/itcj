...
async def indicator_years_page(
    ...
    if not can(MODE_PAGE_PERM[requested]) and can(MODE_PAGE_PERM[other]):
        effective = other
    else:
        effective = requested
    ...
    page_data = {
        ...
        "target_base": "/adhoc/indicadores/" if can(MODE_PAGE_PERM[effective]) else "",
        "target_suffix": "/tablero" if effective == MODE_CONFIG else "/seguimiento",
        "years": years,
...
async def indicator_board_page(
    ...
    page_data = {
        ...
        "tracking_url": f"/adhoc/indicadores/{year.id}/seguimiento",
        "can_create": can("adhoc.indicators.api.create"),
        "can_update": can("adhoc.indicators.api.update"),
        "can_delete": can("adhoc.indicators.api.delete"),
        "can_download": can("adhoc.indicators.api.download"),
        "can_track": can("adhoc.indicators.page.tracking"),
    }
...
async def indicator_tracking_page(
    ...
    return render_adhoc(
        ...
        "adhoc/indicators/tracking.html",
        {
            ...
            "board_url": f"/adhoc/indicadores/{year.id}/tablero",
            "can_manage": can("adhoc.indicators.page.manage"),
