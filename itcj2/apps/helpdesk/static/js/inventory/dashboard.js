...
(function () {
    ...
    async function loadQuickStats() {
        try {
            const response = await fetch('/api/help-desk/v2/inventory/dashboard/widgets/quick-stats', {
                headers: {
    ...
    async function loadAlerts() {
        try {
            const response = await fetch('/api/help-desk/v2/inventory/dashboard/widgets/alerts', {
                headers: {
                    'Authorization': `Bearer ${localStorage.getItem('access_token')}`
                }
            });
    ...
    async function loadCategoryChart() {
        try {
            const response = await fetch('/api/help-desk/v2/inventory/dashboard/widgets/category-chart', {
                headers: {
                    'Authorization': `Bearer ${localStorage.getItem('access_token')}`
                }
            });
            ...
            // Destroy existing instance before recreating (avoid "canvas already in use")
            if (categoryChart) {
    ...
    async function loadStatusChart() {
        try {
            const response = await fetch('/api/help-desk/v2/inventory/dashboard/widgets/status-chart', {
                headers: {
                    'Authorization': `Bearer ${localStorage.getItem('access_token')}`
                }
            });
    ...
    async function loadRecentActivity() {
        try {
            const response = await fetch('/api/help-desk/v2/inventory/dashboard/widgets/recent-activity?limit=10', {
                headers: {
                    'Authorization': `Bearer ${localStorage.getItem('access_token')}`
                }
            });
    ...
    // ==================== HTMX PAGE LIFECYCLE ====================
    window.HelpdeskPage.page('inventory_dashboard', {
        init() {
            // No server data needed via data-*
            loadQuickStats();
            loadAlerts();
            loadCategoryChart();
            loadStatusChart();
