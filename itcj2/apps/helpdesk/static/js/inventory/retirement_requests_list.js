...
(function () {
    ...
    function buildRow(r) {
        const detailUrl = `/help-desk/inventory/retirement-requests/${r.id}`;
        const itemsCount = r.items_count !== undefined ? r.items_count : '—';
        return `<tr style="cursor:pointer;" onclick="window.location='${detailUrl}'">
            ...
            <td class="text-center">
                <a href="${detailUrl}" class="btn btn-sm btn-outline-primary py-0 px-1"
