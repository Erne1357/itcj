...
class InventoryGroupService:
    ...
    @staticmethod
    def generate_group_code(db: Session, department_code: str, group_name: str) -> str:
        """
        ...
        counter = 1
        code = base_code
        while db.query(InventoryGroup).filter_by(code=code).first():
    ...
    @staticmethod
    def create_group(db: Session, data: dict, created_by_id: int) -> InventoryGroup:
        """
    ...
    @staticmethod
    def update_group(db: Session, group_id: int, data: dict) -> InventoryGroup:
    ...
    @staticmethod
    def update_capacities(db: Session, group_id: int, capacities: list) -> InventoryGroup:
        """
        ...
        try:
            ...
            db.query(InventoryGroupCapacity).filter_by(group_id=group_id).delete()
    ...
    @staticmethod
    def get_groups_by_department(db: Session, department_id: int, include_inactive=False):
        """Obtiene todos los grupos de un departamento."""
        query = db.query(InventoryGroup).filter_by(department_id=department_id)
    ...
    @staticmethod
    def get_group_items(db: Session, group_id: int, category_id=None):
        """
    ...
    @staticmethod
    def assign_item_to_group(db: Session, item_id: int, group_id: int, performed_by_id: int) -> InventoryItem:
        """
        Asigna un equipo a un grupo. Valida capacidad disponible.
        """
        try:
    ...
    @staticmethod
    def unassign_item_from_group(db: Session, item_id: int, performed_by_id: int) -> InventoryItem:
        ...
        try:
            ...
            old_group = db.get(InventoryGroup, item.group_id)
