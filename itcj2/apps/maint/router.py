...
from itcj2.apps.maint.api.department_dashboard import router as dept_dashboard_router
...
maint_router.include_router(dept_dashboard_router, prefix="/dashboard")
