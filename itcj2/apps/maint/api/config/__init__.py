"""Config sub-router para maint — Field Templates, Prioridades, Catálogos, Áreas, Auditoría y Notificaciones."""
...
from itcj2.apps.maint.api.config.areas import router as areas_router
from itcj2.apps.maint.api.config.audit import router as audit_router
from itcj2.apps.maint.api.config.notifications import router as notifications_router
