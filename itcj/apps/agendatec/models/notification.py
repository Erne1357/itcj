...
class Notification(db.Model):
    __tablename__ = "agendatec_notifications"
    ...
    source_request_id = db.Column(db.BigInteger, db.ForeignKey("agendatec_requests.id", onupdate="CASCADE", ondelete="SET NULL"))
    source_appointment_id = db.Column(db.BigInteger, db.ForeignKey("agendatec_appointments.id", onupdate="CASCADE", ondelete="SET NULL"))
