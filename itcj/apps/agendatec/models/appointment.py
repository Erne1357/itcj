...
class Appointment(db.Model):
    ...
    request_id = db.Column(db.BigInteger, db.ForeignKey("requests.id", onupdate="CASCADE", ondelete="CASCADE"), unique=True)
    ...
    slot_id = db.Column(db.BigInteger, db.ForeignKey("time_slots.id", onupdate="CASCADE", ondelete="CASCADE"), nullable=False)
